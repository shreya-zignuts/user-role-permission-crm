...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pages-users')->with('success', 'User created successfully.');
    }
    ...
    public function resetPassword(Request $request)
    {
        ...
        if ($user->id === 1) {
            ...
            return redirect()->route('user-dashboard')->with('success', 'User successfully logged in');
        }
    }
    ...
    public function forceLogoutUser(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'User Logged Out Forcefully.');
    }
}
