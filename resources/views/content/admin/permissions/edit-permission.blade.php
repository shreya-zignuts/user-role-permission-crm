            ...
            <div class="modal-body">
                ...
                <form class="row g-3 mt-2" method="POST"
                                        ...
                                        ?>
                                            <tr data-module-code="{{ $module->code }}">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="checkbox" class="module-permission-checkbox add-permission-checkbox" name="permissions[{{ $module->code }}][add_access]" value="1" onclick="checkAccess(this, '{{ $module->code }}', 'add')" {{ $currentModulePermission->add_access ? 'checked' : '' }}>
                                                </td>
                                                <td>
                                                    <input type="hidden" name="permissions[{{ $module->code }}][view_access]" value="0">
                                                    <input type="checkbox" class="module-permission-checkbox main-module-view-checkbox" name="permissions[{{ $module->code }}][view_access]" value="1" onclick="checkMainModuleView(this, '{{ $module->code }}', 'view')" {{ $currentModulePermission->view_access ? 'checked' : '' }}>
                                                </td>
                                                <td>
                                                    <input type="hidden" name="permissions[{{ $module->code }}][edit_access]" value="0">
                                                    <input type="checkbox" class="module-permission-checkbox edit-permission-checkbox" name="permissions[{{ $module->code }}][edit_access]" value="1" onclick="checkAccess(this, '{{ $module->code }}', 'edit')" {{ $currentModulePermission->edit_access ? 'checked' : '' }}>
                                                </td>
                                                <td>
                                                    <input type="hidden" name="permissions[{{ $module->code }}][delete_access]" value="0">
                                                    <input type="checkbox" class="module-permission-checkbox delete-permission-checkbox" name="permissions[{{ $module->code }}][delete_access]" value="1" onclick="checkAccess(this, '{{ $module->code }}', 'delete')" {{ $currentModulePermission->delete_access ? 'checked' : '' }}>
                                                </td>
                                            </tr>
                                        ...
                                        // dd($currentModule, $currentSubModule);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" class="module-permission-checkbox add-permission-checkbox" name="permissions[{{ $submodule->code }}][add_access]" value="1" {{ $currentSubModulePermission->add_access ? 'checked' : '' }} onclick="checkAccess(this, '{{ $module->code }}', 'add')">
                                                    </td>
                                                    <td>
                                                        <input type="hidden" name="permissions[{{ $submodule->code }}][view_access]" value="0">
                                                        <input type="checkbox" class="module-permission-checkbox main-module-view-checkbox" name="permissions[{{ $submodule->code }}][view_access]" value="1" {{ $currentSubModulePermission->view_access ? 'checked' : '' }} onclick="checkMainModuleView(this, '{{ $module->code }}', 'view')">
                                                    </td>
                                                    <td>
                                                        <input type="hidden" name="permissions[{{ $submodule->code }}][edit_access]" value="0">
                                                        <input type="checkbox" class="module-permission-checkbox edit-permission-checkbox" name="permissions[{{ $submodule->code }}][edit_access]" value="1" {{ $currentSubModulePermission->edit_access ? 'checked' : '' }} onclick="checkAccess(this, '{{ $module->code }}', 'edit')">
                                                    </td>
                                                    <td>
                                                        <input type="hidden" name="permissions[{{ $submodule->code }}][delete_access]" value="0">
                                                        <input type="checkbox" class="module-permission-checkbox delete-permission-checkbox" name="permissions[{{ $submodule->code }}][delete_access]" value="1" {{ $currentSubModulePermission->delete_access ? 'checked' : '' }} onclick="checkAccess(this, '{{ $module->code }}', 'delete')">
                                                    </td>
                                                </tr>
                                            @endforeach
                                    @endforeach
                    ...
                    <div class="col-12 text-center mt-4">
                        <button type="submit" class="btn btn-primary me-sm-3 me-1 waves-effect waves-light" id="type-success">Update</button>
