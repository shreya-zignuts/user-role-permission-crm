                            ...
                            <form action="{{ route('update-module', ['moduleId' => $module->code]) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="moduleName"
                                        placeholder="Enter module name" name="name" value="{{ $module->name }}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="text-center mb-4 mt-0">
                                    ...
                                    <a href="{{ route('pages-modules') }}" class="btn btn-secondary">Cancel</a>
                                    <!-- Changed to anchor tag within button class -->
                                </div>
                            </form>
                        </div>
                    </div>
