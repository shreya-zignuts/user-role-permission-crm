              ...
              <div class="d-flex justify-content-center mt-3">
                <div class="modal-content p-3 p-md-5 w-75 align-content-center mt-5">
                    <div class="modal-body">
                      ...
                      @endif
                          ...
                          @endif
                <h5 class="mt-2">Create Company</h5>
                <form class="mt-1" method="POST" action="{{ route('store-company') }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <input id="owner_name" type="text" class="form-control" name="owner_name" placeholder="owner name.. ">
                        @error('owner_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="pt-4">
                        ...
                        <button class="btn btn-label-secondary"><a href="{{ route('userside-company')}}">Cancel</a></button>
