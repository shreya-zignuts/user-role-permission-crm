                ...
                <form class="mt-1" method="POST" action="{{ route('update-notes', $notes->id) }}">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-12">
                        ...
                        <input id="title" type="text" class="form-control" name="title" value="{{ old('title', $notes->title) }}" @error('title')">
                    ...
                    <div class="pt-4">
                        ...
                        <a href="{{ route('userside-notes') }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
