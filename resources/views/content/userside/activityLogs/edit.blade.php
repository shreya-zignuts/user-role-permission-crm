  ...
  <div class="modal-content p-3 p-md-5 w-75 align-content-center mt-5">
      <div class="modal-body">
        ...
        @endif
            ...
            @endif
                <h5 class="mt-2">Edit Activity Log</h5>
                ...
                <form class="mt-1" method="POST" action="{{ route('update-activityLogs', $activityLog->id) }}">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-12">
                        ...
                        <input id="title" type="text" class="form-control" name="title" value="{{ old('title', $activityLog->title) }}">
                        @error('title')
                    ...
                    <div class="pt-4">
                        ...
                        <button class="btn btn-label-secondary"><a href="{{ route('userside-activityLogs')}}">Cancel</a></button>
                    </div>
                </form>
            </div>
        </div>
